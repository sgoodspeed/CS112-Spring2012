...
class TieFighter(object):
    def __init__(self,x,y,vx,vy,bounds,size=40,color=C_RED):
       #Values with defaults need to go at the end of the list of arguments
        self.vx=vx
        self.vy=vy
        self.size=size
        self.color=color
...
##NOTE 1
##Basic idea is that in programming main is the code you run. by default you
##should have that be main. Main is the ONE that RUNS. What this says is that
##if name == main, i you type the name of this file at the command line, it
##will be the MAIN file. If it's main: do all this stuff. When wouldn't it be
##main? If you had libraries I bet.
