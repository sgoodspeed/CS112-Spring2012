#!/usr/bin/env python
#class myList(List) is for making a custom list! Sprite groups are custom lists. These are cooool
import math
...
class Explosion(Sprite):
    ...
    def rand_color(self):
        return randrange(120,256), 0, randrange(120,256)
...
class Game(Application):
    ...
    def update(self):
        ...
        ##THIS IS THE SPRITE COLLIDE FUNCTION IN ACTION aww yeah
        for xplo in self.xplos:
            pygame.sprite.spritecollide(xplo,self.ships,True,collided = collide_xplo_ship)
